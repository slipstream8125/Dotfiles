...
export PATH=/home/asusg14/Flutter/flutter/bin/:$PATH
...
export PATH=/var/cuda-repo-fedora35-11-8-local/cuda-nvcc-11-8-11.8.89-1.x86_64.rpm${PATH:+:${PATH}}
export PATH=/home/asusg14/.spicetify/spicetify${PATH:+:${PATH}}
# To customize prompt, run `p10k configure` or edit ~/.p10k.zsh.
[[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/asusg14/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/asusg14/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/asusg14/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/asusg14/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# bun completions
[ -s "/home/asusg14/.bun/_bun" ] && source "/home/asusg14/.bun/_bun"
